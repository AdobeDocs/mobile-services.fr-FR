...
Pour Analytics, les données contextuelles envoyées avec chaque appel de suivi de cycle de vie sont automatiquement capturées et rapportées à l'aide de la mesure ou de la dimension.
