...
| `{%adid%}` | Renvoie l’identifiant IDFA. Ce jeton fonctionne uniquement si vous avez utilisé `setAdvertisingIdentifier`. |
| `{%pushid%}` | Renvoie le jeton d’identifiant Push. Ce jeton fonctionne uniquement si vous avez utilisé `setPushIdentifier`. |
