...
1. Pour générer à nouveau le rapport, cliquez sur **[!UICONTROL Exécuter]**.
   ...
   Ce rapport présente désormais les utilisateurs ventilés par système d’exploitation. Le titre du rapport a été modifié pour correspondre aux filtres appliqués au rapport.
...
1. Cliquez sur **[!UICONTROL Mettre à jour]** et **[!UICONTROL Exécuter]**.
   ...
   Ce rapport présente désormais les utilisateurs dotés d’iOS 8.3 qui ont lancé l’application pour la première fois.

   ![](assets/customize7.png)

   Prenez le temps de tester les différentes options du menu de personnalisation des rapports et assurez-vous de marquer vos favoris dans un signet. Dans Adobe Mobile, les URL de rapport sont fonctionnelles et peuvent être envoyées par courrier électronique ou ajoutées à vos favoris.
