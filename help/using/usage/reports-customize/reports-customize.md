...
| 7 | Le **[!UICONTROL graphique de données]** affiche les informations sous forme de graphique approprié, sur la base des mesures sélectionnées. Plusieurs types de graphiques sont disponibles : courbes, histogrammes, graphiques en anneau, etc. |
