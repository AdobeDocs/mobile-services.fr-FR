...
1. Vous serez redirigé vers la page de connexion Enterprise.
   ...
   >[!IMPORTANT]
   >
   >Si vous cliquez sur **[!UICONTROL Facebook]** ou **[!UICONTROL Google]** pour vous connecter, l’adresse e-mail associée à votre compte Facebook ou Google doit correspondre à l’adresse e-mail associée à votre Adobe ID ou à votre Enterprise ID qui a accès à Adobe Analytics. Si ce n’est pas le cas, contactez votre administrateur.
...
* **Adobe Experience Cloud** Si vous utilisez votre Adobe ID :
   ...
   1. Saisissez l’adresse e-mail du compte associé à votre Adobe ID, puis cliquez sur **[!UICONTROL Envoyer]**.
