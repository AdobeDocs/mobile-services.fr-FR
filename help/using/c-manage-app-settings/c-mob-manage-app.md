...
* Les **[!UICONTROL Propriétés personnalisées]** (ou props) répondent à la question « laquelle ? » props peuvent être définies sur une valeur textuelle qui sera associée à d’autres variables et mesures envoyées dans le même accès. Ces valeurs peuvent servir à filtrer les rapports ou peuvent être classées par mesure associée.
